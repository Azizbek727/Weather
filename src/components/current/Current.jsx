  ...
  return (
    <div className={s.current}>
        <div className={s.current__info}>
            ...
            <p className={s.current__time}>Время: {getTime(current.dt, 'hour')}:{getTime(current.dt, 'min')} </p>
        ...
        <div className={s.current__content}>
            ...
            <div className={s.current__card}>
                ...
                <p className={s.current__desc}>{Math.round(current.wind_speed)} м/с {getWind(current.wind_deg)} - ветер</p>
            </div>
        </div>
    </div>
  )
